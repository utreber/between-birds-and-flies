$(function() { // wait for document ready
    ...
    $(document).ready(function() {
        controller = controller.update(true);
    });
    ...
    function fade(element, from, to) {
        return TweenMax.fromTo(element, {
            opacity: from
        }, {
            opacity: to,
    ...
    var changeBackgroundColor = (from, to) => TweenMax.fromTo("body", {
    ...
    var changeColor = (from, to) => TweenMax.fromTo(".language-picker-color", {
        color: from
    }, {
        color: to,
        immediateRender: false,
    ...
    var coopCarSceneOut = new ScrollMagic.Scene({
        ...
        .setTween(slideOutCoopCar)
        .addTo(controller);
    var antonioIn = fade("#antonio", 0, 1);
    var slideInAntonio = slide("#antonio", "-100%", 0)
    ...
    var slideOutAntonio = slide("#antonio", 0, "-100%")
    ...
    var slideInFlood3 = slide("#flood3", "-100%", 0);
    var fadeOutFlood3 = fade("#flood3", 1, 0);
    var slideOutFlood3 = slide("#flood3", 0, "-100vw");
    ...
    var slideInTurtle = slide("#turtle", "-100%", 0);
    ...
    var pinCoopSection = new ScrollMagic.Scene({
        ...
        .setPin("#section2")
        .addTo(controller);
    var pinAntonioScene = new ScrollMagic.Scene({
            triggerElement: "#pin-antonio",
            duration: "50%"
        })
        .setPin("#antonio")
